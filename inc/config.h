...
/* These points may be transformed at compile time to their CPU count equivalents, but
runtime transformations still needed for JSTK/XLDA modes */

#define MAX_DELTA_POS      0.3 // SCARA arm max movement step in centimeters (absolute value)
...
#define JSTK_X_MAX         210 // [0 <= JSTK_X_MIN <= JSTK_X_MAX <= 255]
#define JSTK_X_MIN         90
#define JSTK_Y_MAX         200 // [0 <= JSTK_Y_MIN <= JSTK_Y_MAX <= 255]
#define JSTK_Y_MIN         60
